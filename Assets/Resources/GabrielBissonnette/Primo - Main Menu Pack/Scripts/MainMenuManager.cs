...
*/
        Shader.SetGlobalFloat("lightsize", _volume);
        //Debug.Log(_volume);
        
    }

    public void SetBias(float _volume)
    {
        Shader.SetGlobalFloat("_gShadowBias", _volume);
    }

    void SetStartVolume()
    {
        Shader.SetGlobalFloat("lightsize", 0.500f);
        Shader.SetGlobalFloat("_gShadowBias", 0.068f);
    ...
    public void SetQuality(int _qualityIndex)
    {
        ...
        if(_qualityIndex == 0)
        {
            ...
            //Shader.SetGlobalFloat("ShadowMapSize", 1024);

        }
        if (_qualityIndex == 1)
        {
            //Debug.Log(_qualityIndex);
            //Shader.SetGlobalFloat("ShadowMapSize", 2048);
        }
        if (_qualityIndex == 2)
        {
            //Debug.Log(_qualityIndex);
            //Shader.SetGlobalFloat("ShadowMapSize", 4096);
        }
